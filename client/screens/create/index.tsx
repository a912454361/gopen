...
export default function CreateScreen() {
  ...
  }, [prompt, selectedModel, activeType, userId, isMember, isSuperMember, router]);
            ...
            <View style={styles.typeGrid}>
              {CREATE_TYPES.map((type) => (
                ...
                >
                  ...
                  {type.comingSoon && (
                    <View style={[styles.comingSoonBadge, { backgroundColor: `${theme.textMuted}20` }]}>
                      <ThemedText variant="tiny" color={theme.textMuted}>即将上线</ThemedText>
                    </View>
                  )}
                </TouchableOpacity>
              ))}
